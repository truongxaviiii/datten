  ...
  const signinForm = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      displayName: Yup.string()
        .required("displayName không được bỏ trống"),
      confirmPassword: Yup.string()
        .oneOf([Yup.ref("password")], "confirmPassword không khớp")
        .min(8, "confirmPassword ít nhất 8 ký tự")
        .required("confirmPassword không được bỏ trống")
    }),
